...
# <https://metacoglab.github.io/hmetad_workshop> { .dark style="font-size: 0.6em" }

![](figures/qr_code.svg){.center-horizontally}
...
:::{.incremental .much-smaller}
- Bayesian models [@fleming2017self; @mamassian2025confidence; @boundy2023confidence; @kozyra2026]
- Temporally dynamic models [@maniscalco2021; @desender2022dynamic; @hellmann2024confidence]
- Post-decisional models [@navajas2016post; @hellmann2024confidence]
- Models of global metacognition [@katyal2025; @rouault2019forming]
:::

::: {.fragment}
Helpful reviews [@rausch2023; @rahnev2025comprehensive]
:::

## Entry points into the literature

- @fleming2024metacognition
- @mamassian2016visual
- @rahnev2022consensus
- @rahnev2021visual
- @peters2022towards
...
![](figures/qr_code.svg){.center-horizontally style="width: 300px;"}
...
\begin{align*}
	...
	\textrm{meta-}d' &= \textrm{exp}(\textrm{log-}M) \; d' \\
		\textrm{meta-}c &= \begin{cases}
            c & \textrm{ABSOLUTE} \\
            \textrm{exp}(\textrm{log-}M) \; c & \textrm{RELATIVE} \\
        \end{cases} \\
